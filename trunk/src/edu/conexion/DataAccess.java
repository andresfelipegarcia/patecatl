...
public final class DataAccess {
   ...
   public DataAccess() throws Exception {
        //sUrl = "jdbc:postgresql://localhost/suscripcionesdb";
     ...
     */
    public synchronized int executeCommand(String psStatement) 
            throws Exception {
     ...
     */
    public synchronized int executeCommand(Vector<String> pvStatement) 
            throws Exception {
     ...
     */
    private synchronized Vector<Object> convierteAVector( ResultSet rset, 
